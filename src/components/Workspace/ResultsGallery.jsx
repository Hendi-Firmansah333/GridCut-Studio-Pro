...
export default function ResultsGallery({
  ...
  return (
    <div className="flex flex-col flex-1 h-full animate-in fade-in duration-300">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 px-6 pt-6 pb-4 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
